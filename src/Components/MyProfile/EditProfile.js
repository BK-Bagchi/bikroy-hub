        ...
        <section className="profile container">
            ...
            <div className="profile-form">
                <form className="d-flex flex-column align-items-center" onSubmit={handleSubmit}>
                    ...
                    <input type="text" placeholder="Enter Your Business name" name='businessName' value={formData.businessName} onChange={handelFormInput}/>
                    <input type="number" placeholder="Enter Your Contact" name='phoneNumber' value={formData.phoneNumber} onChange={handelFormInput}/>
                    <div className="about-user">
                        <p>Write something about your business so that others can connect to you.</p>
                        <textarea placeholder="About your business..." name="aboutBusiness" value={formData.aboutBusiness} onChange={handelFormInput}></textarea>
                    </div>
